...
void sortAlumnos(int legs[], char mat[][20], char sexos[], int ages[], int nota1[], int nota2[], float promedios[],  int tam, int criterio);
void sortAlumnosSexoLeg(int legs[], char sexos[], int ages[], int nota1[], int nota2[], float promedios[],  int tam, int criterio);
...
int main()
{
    ...
    char nombres[TAM][20] = {"Juan", "Ana", "Pedro", "Andres", "Andres"};

    printf("Muestro el listado: \n\n");
    mostrarAlumnos(legajos, nombres, sexos, edades, nota1, nota2, promedios, TAM);

    /*
    printf("Muestro Ordenado por legajo ascendente o descendente: \n\n");
    sortAlumnos(legajos, sexos, edades, nota1, nota2, promedios, TAM, 1);
    mostrarAlumnos(legajos, nombres, sexos, edades, nota1, nota2, promedios, TAM);

    printf("MUESTRO ORDENADO POR SEXO Y LEGAJO ASCENDENTE O DESCENDENTE:\n\n");
    sortAlumnosSexoLeg(legajos, sexos, edades, nota1, nota2, promedios, TAM, 0);
    mostrarAlumnos(legajos, nombres, sexos, edades, nota1, nota2, promedios, TAM);
    */
